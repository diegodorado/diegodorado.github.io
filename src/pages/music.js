...
const urls = {
  ...
  amazon: 'https://www.amazon.com/s?k=Diego+Dorado&i=digital-music&search-type=ss&ref=ntt_srch_drd_B084155L66',
  youtube: 'https://music.youtube.com/channel/UCz6uOhdNUiTAjt1mBzoV-AA',
  deezer: 'https://www.deezer.com/us/artist/83574592',
}
const links = Object.entries(urls).map( ([k,v]) => <a href={v} target="_blank" rel="noopener noreferrer">{k}</a>)
...
const MusicPosts = () => {
  ...
  const albums = [3644547653, 2587024292, 3583596473, 121085935, 1868484386, 956909203, 3975334759]
          ...
          return (
            <article key={id}>
              <div className="bandcamp">
                <iframe title={id} src={`https://bandcamp.com/EmbeddedPlayer/album=${id}/size=large/${colors}/transparent=true/`} seamless></iframe>
              </div>
            </article>
          )
        })}
