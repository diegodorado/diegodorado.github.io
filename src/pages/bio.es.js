  ...
  render() {
    ...
    return (
      <Layout location={this.props.location} >
        <SEO title="bio" />
        <p className="spacey">Soy Diego Dorado, livecoder, programmer and electronic artist. I am passionate about research projects that combine technological innovation with artistic expressions.
        </p>
